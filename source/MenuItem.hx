...
class MenuItem extends FlxSpriteGroup
{
	...
	{
		super(x, y);
		var pathSuffix = weekNum <= 6 ? Std.string(weekNum) : "_" + HelperFunctions.sanitizeString(weekName);
		week = new FlxSprite().loadGraphic(Paths.image('storymenu/week' + pathSuffix));
		add(week);
	}
