...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	var player2:Character = new Character(0,0, new Identifier("basegame", "dad"), Opponent, false);
	var player1:Boyfriend = new Boyfriend(0,0, new Identifier("basegame", "bf"), Player, false);
	...
	override function create()
	{
		...
		leftIcon = new HealthIcon(Registry.characters.get(_song.player1).icon);
		rightIcon = new HealthIcon(Registry.characters.get(_song.player2).icon);
